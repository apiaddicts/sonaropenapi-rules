...
public class OAR069PathParamAndQueryCheck extends BaseCheck {
    ...
    private void visitOperationNode(JsonNode node) {
        List<JsonNode> parameters = node.getDescendants(OpenApi2Grammar.PARAMETER, OpenApi3Grammar.PARAMETER, OpenApi31Grammar.PARAMETER, OpenApi32Grammar.PARAMETER)
            .stream()
