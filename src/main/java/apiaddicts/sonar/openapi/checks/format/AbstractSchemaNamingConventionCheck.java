...
public abstract class AbstractSchemaNamingConventionCheck extends AbstractNamingConventionCheck {
  ...
  protected AbstractSchemaNamingConventionCheck(String key, String message, String namingConvention) {
  ...
  private void visitPathsNode(JsonNode pathsNode) {
    pathsNode.propertyMap().values().forEach(pathNode -> pathNode.propertyMap().values().forEach(operationNode -> {
