...
import apiaddicts.sonar.openapi.checks.apim.wso2.*;
import apiaddicts.sonar.openapi.checks.format.*;
import apiaddicts.sonar.openapi.checks.schemas.*;
import apiaddicts.sonar.openapi.checks.examples.*;
import apiaddicts.sonar.openapi.checks.owasp.*;
import apiaddicts.sonar.openapi.checks.parameters.*;
import apiaddicts.sonar.openapi.checks.regex.OAR112RegexCheck;
import apiaddicts.sonar.openapi.checks.security.*;
import apiaddicts.sonar.openapi.checks.operations.*;
