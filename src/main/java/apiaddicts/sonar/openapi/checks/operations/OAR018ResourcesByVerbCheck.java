...
public class OAR018ResourcesByVerbCheck extends AbstractVerbPathCheck {
	...
	private static final String DEFAULT_RESOURCES_BY_VERB = GET_ALL_1ST_LEVEL + GET_ALL_2ND_LEVEL + GET_ALL_3RD_LEVEL +
	...
	@RuleProperty(key = "allowed-resources-paths", description = "List of allowed resources path. Format: <V>,<V>:<RX>,<RX>;<V>,<V>:<RX>,<RX>", defaultValue = DEFAULT_RESOURCES_BY_VERB)
	...
	protected void mismatchV2(JsonNode node, JsonNode operationNode, String verb, String path) {
		addIssue(KEY, translate(MESSAGE,path,verb.toUpperCase()), operationNode.key());
	}
}
