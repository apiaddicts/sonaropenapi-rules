...
import apiquality.sonar.openapi.checks.resources.OAR038StandardCreateResponseCheck;
...
public class OAR038StandardCreateResponseCheckTest extends BaseCheckTest {
    ...
    public void verifyRule() {
        assertRuleProperties("OAR038 - StandardCreateResponse - Creation response schema must be compliant with the standard", RuleType.BUG, Severity.MAJOR, tags("resources"));
    }
