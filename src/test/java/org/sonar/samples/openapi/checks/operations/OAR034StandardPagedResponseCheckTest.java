...
import apiquality.sonar.openapi.checks.operations.OAR034StandardPagedResponseCheck;

public class OAR034StandardPagedResponseCheckTest extends BaseCheckTest {

    @Before
    public void init() {
        ruleName = "OAR034";
        check = new OAR034StandardPagedResponseCheck();
    ...
    public void verifyRule() {
        assertRuleProperties("OAR034 - StandardPagedResponse - Paged response schema must be compliant with the standard", RuleType.BUG, Severity.BLOCKER, tags("operations"));
    }
}
