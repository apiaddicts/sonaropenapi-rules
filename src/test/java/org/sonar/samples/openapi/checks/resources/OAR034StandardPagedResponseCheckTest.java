...
import apiquality.sonar.openapi.checks.resources.OAR034StandardPagedResponseCheck;
...
public class OAR034StandardPagedResponseCheckTest extends BaseCheckTest {
    ...
    public void verifyRule() {
        assertRuleProperties("OAR034 - StandardPagedResponse - Paged response schema must be compliant with the standard", RuleType.BUG, Severity.BLOCKER, tags("resources"));
    }
}
