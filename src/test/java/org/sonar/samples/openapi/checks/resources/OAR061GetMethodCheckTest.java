...
public class OAR061GetMethodCheckTest extends BaseCheckTest {
    ...
    public void verifyRule() {
        assertRuleProperties("OAR061 - GetMethod - Response codes in GET operations must be defined according to the standard", RuleType.BUG, Severity.MAJOR, tags("resources"));
    }

    @Override
    public void verifyParameters() {
        assertNumberOfParameters(2);
        assertParameterProperties("mandatory-response-codes", "200 or 202 or 206", RuleParamType.STRING);
