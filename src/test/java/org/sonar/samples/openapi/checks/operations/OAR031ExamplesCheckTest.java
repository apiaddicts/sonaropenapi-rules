...
import apiquality.sonar.openapi.checks.operations.OAR031ExamplesCheck;
...
public class OAR031ExamplesCheckTest extends BaseCheckTest {
    ...
    public void verifyRule() {
        assertRuleProperties("OAR031 - Examples - Responses, Request Body, Parameters and Properties must have an example defined", RuleType.BUG, Severity.MAJOR, tags("operations"));
    }
