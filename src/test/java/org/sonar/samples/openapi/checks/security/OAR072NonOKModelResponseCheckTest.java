...
import apiquality.sonar.openapi.checks.security.OAR072NonOKModelResponseCheck;
...
public class OAR072NonOKModelResponseCheckTest extends BaseCheckTest {
    ...
    public void verifyRule() {
        assertRuleProperties("OAR072 - NonOKModelResponseCheck - Non OK responses shouldnt have stackTraces", RuleType.VULNERABILITY, Severity.MAJOR, tags("vulnerability"));
    }
}